export default function FullstackDev() {
  return (
    <>
      <div className=" ">
        <div className="bg-green-300  p-3  h-60">
          <div className="bg-gray-300 mt-5 rounded-lg p-1">
          ...
          /> */}
            ...
            <ul className="bg-gray-200 p-1 shadow-2xl font-sanf text-lg flex flex-col gap-y-3 tracking-wider text-shadow-sm ">
              <li className=" ">
                HTML{" "}
                <img
              ...
              <li>
                REACT JS{" "} <span className="text-blue-500 ml-2">(Intermedeit)</span>
                <img
                  className="w-6 ml-1 inline"
              ...
              <li>
                DEPLOYEMENT{" "} <span className="text-blue-500 ml-2">(Intermedeit)</span>
                <img
                  className="w-6 ml-1 inline"
              ...
              <li className="bg-black text-white pl-2 rounded-lg">
                GITHUB <span className="text-red-500 ml-2">(Intermedeit)</span>
                <img
                  className="w-6 ml-1 inline"
