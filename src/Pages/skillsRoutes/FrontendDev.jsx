  ...
  return (
    ...
    <div className="md:flex flex-wrap">
      ...
      {frontendProjects.map((items, index) => {
        return (
          <div key={index}   className="bg-[#1f1f1f] border-2 m-2 text-white rounded-2xl p-5 w-72 md:w-95 shadow-md
              ...
              <div>
                ...
                <a href="https://github.com/Gurpreet-bit-maker/project_weather.git">Code Link</a>
                <br />
                <a href="">Live Demo</a>
              </div>
            </div>
